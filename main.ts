...
controller.menu.onEvent(ControllerButtonEvent.Pressed, function () {
    if (on == 1) {
        ...
        sprites.destroyAllSpritesOfKind(SpriteKind.Button)
        scene.setBackgroundImage(assets.image`Black void`)
        Shut_down_bar = sprites.create(assets.image`Shutdown bar`, SpriteKind.Player)
        Shut_down_bar.sayText("Shutting down...")
        ...
        pause(4000)
        Shut_down_bar.sayText("It is now safe to turn off your computer")
    }
})
controller.combos.attachCombo("A+B+u", function () {
    clear_disk()
})
let Shut_down_bar: Sprite = null
let password = 0
let Jokes: string[] = []
